...
if [ "$1" = "" ] || [ "$1" = "build" ]; then
	...
	BUILD_REQUIRES="libsemio-dev (>= 1.18.4), libroscpp-dev, libtf2-ros-dev, libvisualization-msgs-dev, catkin, ros-message-generation"
	RUN_REQUIRES="'libsemio (>= 1.18.4)', libroscpp1d, libtf2-ros0d"
